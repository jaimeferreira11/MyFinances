...
import py.ideasweb.myfinances.views.transaction.EditTransactionActivity;
...
public class TimeSection extends StatelessSection {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        String amount = String.format("%s%s%s", transaction.isIncome() ? "+" : "-" , "Gs. ", Utilities.toStringFromFloatWithFormat(transaction.getValue()));
