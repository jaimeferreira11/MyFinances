package py.ideasweb.myfinances.views.dashboard;
...
public class DashboardFragment extends Fragment {
    ...
    private PieEntry setCategoryB(Map.Entry<MyCategory, Float> entry) {
        ...
        expenseCategoryBValue.setText("Gs. " + Utilities.toStringFromFloatWithFormat(entry.getValue()));
    ...
    private PieEntry setCategoryC(Map.Entry<MyCategory, Float> entry) {
        ...
        expenseCategoryCValue.setText("Gs. " + Utilities.toStringFromFloatWithFormat(entry.getValue()));
        expenseCategoryCWrapper.setVisibility(View.VISIBLE);
        return new PieEntry(entry.getValue());
    }

    private PieEntry setOthersCategories(float accum) {
        expenseOtherValue.setText("Gs. " + Utilities.toStringFromFloatWithFormat(accum));
    ...
    private void showBalanceTimelineCard(){
       // String symbol = Currency.getInstance(Locale.getDefault()).getSymbol();
        ...
        if(budget > 0){
            ...
            LineDataSet budgetDataSet = new LineDataSet(budgetEntries, "Presupuesto maximo del mes");
    ...
    private void showMonthlyBudgetCard(){
       ...
       // String symbol = "Gs. ";
        ...
        budgetValue.setText( symbol + Utilities.toStringFromFloatWithFormat(value) );
        budgetSpent.setText( symbol + Utilities.toStringFromFloatWithFormat(spent) );
        budgetPredicted.setText(symbol  + Utilities.toStringFromFloatWithFormat(remaning));
    ...
    private void showMonthlyBalanceCard(){
      //  String symbol = Currency.getInstance(Locale.getDefault()).getSymbol();
        ...
        incomeValue.setText(symbol + Utilities.toStringFromFloatWithFormat(monthTotalIncomes));
        expensesValue.setText(symbol + Utilities.toStringFromFloatWithFormat(monthTotalExpenses));
        balanceTotal.setText(symbol + Utilities.toStringFromFloatWithFormat((monthTotalIncomes - monthTotalExpenses)));
