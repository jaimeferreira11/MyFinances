package py.ideasweb.myfinances.controller;

import py.ideasweb.myfinances.database.BudgetDatabase;
import py.ideasweb.myfinances.database.BudgetDatabaseLocal;
import py.ideasweb.myfinances.database.CategoriesDatabase;
import py.ideasweb.myfinances.database.CategoriesDatabaseLocal;
import py.ideasweb.myfinances.database.TransactionDatabase;
import py.ideasweb.myfinances.database.TransactionDatabaseLocal;
...
public class Controller {
    ...
    public boolean removeAllBudget(){
        return databaseB.removeAll();
    }
}
